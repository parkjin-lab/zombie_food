...
Add-SourceContainsCheck $sourceSyncChecks "combat_lanes_fill_overview_panel" $hudSource "float combatLaneHeight = minimalCombatStrip ? 96f : 960f;"
Add-SourceContainsCheck $sourceSyncChecks "combat_lane_rows_fill_overview_panel" $hudSource "float combatLaneRowHeight = minimalCombatStrip ? 30f : 306f;"
Add-SourceContainsCheck $sourceSyncChecks "combat_lane_rows_keep_min_readability" $hudSource "float combatLaneRowMinHeight = minimalCombatStrip ? 24f : 236f;"
